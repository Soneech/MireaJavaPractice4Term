...
public class AuthorsController {
    ...
    @PostMapping
    public String addAuthor(@ModelAttribute("author") GameAuthor author) {
    ...
    @PatchMapping("/{id}")
    public String updateAuthor(@PathVariable("id") long id, @ModelAttribute("author") GameAuthor author) {
